...
4. Obtenir le plan complet
    ...
    # ── STEP 2 : Décomposition du problème ──────────────────────────────────
        ...
        # Persister le choix radio en session_state (comme étape 3)
        if 'decomp_validation' not in st.session_state:
            st.session_state.decomp_validation = "Oui, je valide"
        ...
        with col_a:
            validation = st.radio(
                ...
                index=0 if st.session_state.decomp_validation == "Oui, je valide" else 1,
                key="radio_decomp_validation"
            )
            st.session_state.decomp_validation = validation
        with col_b:
